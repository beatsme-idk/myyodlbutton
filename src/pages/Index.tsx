      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8 space-y-3">
          <div className="flex justify-center mb-4">
            <div className="animate-pulse-subtle inline-flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-tr from-indigo-500 to-purple-600 shadow-glow">
          ...
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-gradient animate-fade-in">
            Create Payment Buttons
          </h1>
          
          <p className="text-base text-slate-300 max-w-2xl mx-auto animate-fade-in-up delay-150">
        ...
        <div className="neo-blur rounded-2xl shadow-xl overflow-hidden border border-indigo-500/30 animate-slide-up mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            <div className="p-6 border-b lg:border-b-0 lg:border-r border-indigo-500/20">
              <h2 className="text-xl font-semibold mb-6 text-gradient-blue flex items-center">
            ...
            <div className="p-6 bg-gradient-to-br from-slate-900 to-indigo-950/40">
              <h2 className="text-xl font-semibold mb-6 text-gradient-purple flex items-center">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
